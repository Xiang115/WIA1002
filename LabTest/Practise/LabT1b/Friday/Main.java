...
public class Main {
    public static void main(String[] args) {
        ...
        Login logins = new Login(new ArrayList<>(List.of(
                new Data<>("user1", new Coordinates(-80.3, 79.1), 0),
                new Data<>("user2", new Coordinates(95.6, -112.3), 0),
                new Data<>("user2", new Coordinates(80.4, 165.4), 2),
                new Data<>("user2", new Coordinates(78.2, 177.3), 1),
                new Data<>("user3", new Coordinates(-128.3, 12.5), 3),
                new Data<>("user3", new Coordinates(3.5, 23.7), 0)
        )));
